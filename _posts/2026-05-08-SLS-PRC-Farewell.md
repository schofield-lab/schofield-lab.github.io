...
tags: [news, synchrotron, service, Switzerland, SLS]
image: /images/blog/2026/2026-05-08_PRC_clock.jpg
author: steven-schofield
---

This week I was at the [Paul Scherrer Institut (PSI)](https://www.psi.ch), about an hour outside Zurich, for what was my final in-person meeting with the [Swiss Light Source (SLS)](https://www.psi.ch/en/sls) Proposal Review Committee (PRC).
...
<figure class="blog-image">
  <img src="{{ '/images/blog/2026/2026-05-08_PRC_ring.png' | relative_url }}" alt="The SoftXAS sub-committee of the SLS PRC inside the SLS2.0 storage ring">
  <figcaption>The SoftXAS sub-committee of the SLS PRC inside the SLS 2.0 storage ring during our final in-person meeting, May 2026.</figcaption>
</figure>

  <!-- <figcaption>The SoftXAS sub-committee of the SLS PRC inside the SLS 2.0 storage ring. Left to right: Steven Schofield (UCL), Tohru Araki (Institute for Molecular Science, Japan), Wolfgang Kuch (Freie Universität Berlin), Arantxa Fraile Rodríguez (University of Barcelona), Markus Etzkorn (Technische Universität Braunschweig), Lucia Aballe (ALBA Synchrotron, Barcelona), Sara Blomberg (Lund University), and Georg Held (Diamond Light Source / University of Reading). Also members of the sub-committee but absent from the photo: Christian Papp (Freie Universität Berlin) and Eva Benckiser (Max Planck Institute for Solid State Research, Stuttgart).</figcaption> -->
