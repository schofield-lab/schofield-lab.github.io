...
This week marks the end of a successful two-week visit to our group by [Dr Rebecca Rodrigues de Miranda](https://linkedin.com/in/rrodriguesdem) from the [Institute of Condensed Matter Chemistry of Bordeaux (ICMCB)](https://www.icmcb-bordeaux.cnrs.fr/en/).
...
Rebecca, a postdoctoral researcher working with [Dr Mathieu Gonidec](https://linkedin.com/in/mathieu-gonidec-a270632b) at ICMCB–CNRS, first became interested in SCOs during her PhD studies under the supervision of [Dr Patrick Rosa](https://linkedin.com/in/patrick-rosa-b664141b). Together with their team, they demonstrated that an iron(II) SCO compound functionalised with a long alkyl chain exhibits *reversibly switchable* behaviour when formed into a self-assembled monolayer (SAM) on gold substrates ([ACS Nano 19, 36566–36577 (2025)](https://doi.org/10.1021/acsnano.5c11659)). This result is particularly noteworthy because direct contact between SCO molecules and a metallic substrate often suppresses or “pins” their switchable behaviour, undermining their potential for device applications.  

<figure class="blog-image">
  <img src="{{ '/images/blog/2025/2025-11-14_Rebecca_ICMBC.jpg' | relative_url }}" alt="Dr. Rebecca Rodrigues de Miranda visiting the LCN at UCL">
  <figcaption>Dr Rebecca Rodrigues de Miranda transferring liquid nitrogen to the low-temperature scanning tunnelling microscope (LT-STM) during her visit to the London Centre for Nanotechnology, UCL (Nov 2025).</figcaption>
</figure>
...
The first step in preparing the SAMs is to produce what are known as *template-stripped gold* substrates. This involves evaporating a 200-nm layer of gold onto a silicon wafer and then adhering a small glass substrate to the gold. The samples were brought from France in this form. Once at UCL, the gold surface was exposed by detaching the silicon wafer to reveal an atomically flat, pristine gold surface.  

<figure class="blog-image">
  <img src="{{ '/images/blog/2025/2025-11-14_Rebecca_TSAu.jpg' | relative_url }}" alt="STM image of template stripped gold">
  <figcaption>STM image of atomically flat gold terraces on a template-stripped gold sample prior to formation of the self-assembled monolayer.</figcaption>
</figure>
...
*Rebecca gratefully acknowledges the support of [Quantum Matter Bordeaux (QMBx)](https://quantum-matter-bordeaux.cnrs.fr) for funding her visit.*
