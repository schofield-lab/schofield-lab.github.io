...
A PDF version of [my poster](/assets/posters/2026-08-Egan-TFSG-Summer-School-Poster.pdf) is available on the [presentations page](/presentations/) of this website. My supervisor also attended for a day and gave [the STM talk](/assets/slides/2026-08-SRS-TFSG-Summer-School.pdf) at the conference, and his slides are available there too.

<div class="blog-image-row">
  <figure class="blog-image">
    <a href="{{ '/assets/posters/2026-08-Egan-TFSG-Summer-School-Poster.pdf' | relative_url }}">
      <img src="{{ '/images/research/2026-08-Egan-TFSG-Summer-School-poster-thumbnail.jpg' | relative_url }}" alt="Thumbnail of Sean Egan's poster, Towards Arsenic in Germanium Quantum Devices">
    </a>
    <figcaption>My poster, <em>Towards Arsenic in Germanium Quantum Devices</em>.</figcaption>
  </figure>
  <figure class="blog-image">
    <a href="{{ '/assets/slides/2026-08-SRS-TFSG-Summer-School.pdf' | relative_url }}">
      <img src="{{ '/images/research/2026-08-TFSG-summer-school-thumbnail.jpg' | relative_url }}" alt="Thumbnail of Steven Schofield's talk slides, Scanning Tunnelling Microscopy (STM)">
    </a>
    <figcaption>Steven's talk, <em>Scanning Tunnelling Microscopy (STM)</em>.</figcaption>
  </figure>
</div>
